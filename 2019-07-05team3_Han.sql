...
-- 팔로우인지 조회
SELECT ID, GIVEUSERID, TAKEUSERID, FOLLOWDATE
FROM FOLLOW
WHERE GIVEUSERID = 'B001' AND TAKEUSERID = 'BLUMBALD';

-- 팔로우 
INSERT INTO FOLLOW(ID, GIVEUSERID, TAKEUSERID, FOLLOWDATE) VALUES(FOLLOW_SEQ.NEXTVAL, GIVEUSERID, TAKEUSERID, SYSDATE);
