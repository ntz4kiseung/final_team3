			...
			<div class="MyPage flex-item-grow flex-col-center-up">
                    ...
                    <div class="flex-item-grow flex-row-left-up">
                        <div class="MyPage-nav flex-col-center-up">                          
                            <div><a class="navnonclick" href="profile.action?userId=${opUser}">프로필</a></div>
                            <div><a class="navnonclick" href="opbadge.action?userId=${opUser}">뱃지</a></div>
                            <div><a class="navclick" href="opcreatepostlist.action?userId=${opUser}">개설모임</a></div>
                        </div>
                        ...
                        <div class="MyPage-body flex-item-grow flex-col-center-center">
                            ...
                            <div class="MyPage-body-header flex-row-left-center">
                                <span ><a  class="navclick" >개설모임</a></span>&nbsp;&nbsp;&nbsp;
                            </div>
                            ...
                            <div class="MyPage-body-body">
                                <div class="PostList flex-col-left-center">
                                    ...
                                    <div class="PostList-post flex-row-left-center">
                                        <div class="PostList-post-left flex-col-center-center" onclick="location.href='profile.action?userId=${opUser}'">
