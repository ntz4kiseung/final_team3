      ...
      $("#btn-check-id2").click(function()
            {
               ...
               if (inputid == "") {
                  ...
                  $("#span-check-id2").text("아이디를 입력해주세요.");
                  return false;
               }
                    ...
                    <div class="flex-item-grow flex-row-left-up">
                        ...
                        <div class="MyPage-body flex-item-grow flex-col-center-center">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                       ...
                                       <div class="control-group">
                                           <div class="div-check">
                                              <span class="span-check" id="span-check-id2" style="text-align: center;"></span>
                                           </div>
                                        </div>
                         ...
                         <!-- 모달 -->
                              ...
                              <!--답장하기 모달  -->
                                             <div class="modal fade" id="messageModal${message.messageId }" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                          ...
                                          <div class="modal-body">
                                              <div class="control-group flex-row-center-center">
                                                <div for="destinataire" style="padding-right: 15px;" >받는 사람</div>
                                                <div><input type="text" class="form-control takeUserId" name="takeUserId" id="takeUserId" 
                                                readonly="readonly" value="${message.giveUserId }"></div>
                                             </div>
