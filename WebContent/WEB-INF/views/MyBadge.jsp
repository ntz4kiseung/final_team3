...
<link
	href="https://fonts.googleapis.com/css?family=Handlee|Noto+Sans+KR&display=swap"
	rel="stylesheet">
<!-- sagyo.css -->
				...
				<div class="MyPage flex-item-grow flex-col-center-up">
					...
					<c:forEach var="List" items="${ myPageList }" varStatus="status">
						<div class="MyPage-header flex-row-left-center">
							<div class="MyPage-header-left flex-col-center-center">
								<div class="MyPage-header-badge">
									<div class="user-badge-box">
										<img class="user-bad-badge"
											src="${MyPageBad[status.index].urlBad }" alt=""> <img
											id="user_main" src="<%=cp %>/${List.url } ">
									</div>
								</div>
								<div class="star-show star-25-box">
									<div>
										<img class="grayscale" id="1" src="img/star.png" alt="" /> <img
											class="grayscale" id="2" src="img/star.png" alt="" /> <img
											class="grayscale" id="3" src="img/star.png" alt="" /> <img
											class="grayscale" id="4" src="img/star.png" alt="" /> <img
											class="grayscale" id="5" src="img/star.png" alt="" />
									</div>
									<div>
										<img class="" id="1" src="img/star.png" alt="" /> <img
											class="" id="2" src="img/star.png" alt="" /> <img class=""
											id="3" src="img/star.png" alt="" /> <img class="" id="4"
											src="img/star.png" alt="" /> <img class="" id="5"
							...
							<div class="MyPage-header-right flex-item-grow">
								<div class="MyPage-header-nickname">${List.nickname }</div>
					...
					<div class="flex-item-grow flex-row-left-up">
						<div class="MyPage-nav flex-col-center-up">
							<div>
								<a class="navnonclick" href="myprofile.action">프로필</a>
							</div>
							<div>
								<a class="navnonclick" href="mymessagerecevie.action">쪽지함</a>
							</div>
							<div>
								<a class="navclick" href="mybadge.action">뱃지</a>
							</div>
							<div>
						...
						<div class="MyPage-body flex-item-grow flex-col-center-center">
							...
							<div class="MyPage-body-header flex-row-left-center">뱃지</div>
														...
														<div id="inbody">
															<div class="MyFollow-user flex-row-left-center">
																<div class="flex-col-left-center">
																	...
																	<div>
																		<button type="button"
																			${List.badgeCk==0 ? "class='btn modalbutton'" : "class='btn btn-orange selectBadge'" }
																			${List.badgeCk==1 ? "" : "disabled='disabled'" }
																			value="${List.badgeLogId }">대표뱃지 설정</button>
																	</div>
																</div>
																<div class="flex-col-left-center"
                        ...
                        <div class="MyPage-header-right flex-item-grow">
                            ...
                            <div class="MyPage-header-detail">
                             <div>${myPageAddrList[status.index].addrSiName1 }   ${myPageAddrList[status.index].addrGuName1 }  ${myPageAddrList[status.index].addrSiName2 } ${myPageAddrList[status.index].addrGuName2 } 
                                ...
                                <div>${myPageInterList[status.index].interSubName1 }  ${myPageInterList[status.index].interSubName2 }
                                ${myPageInterList[status.index].interSubName3 }</div> 
