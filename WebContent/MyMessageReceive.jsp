                                    ...
                                    <div class="MyMessage-body flex-item-grow">
                                        ...
                                        <div class="accordion" id="NoticeAccordion">
                                                ...
                                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#NoticeAccordion">
                                                    <div class="card-body flex-col-left-up">
                                                        ...
                                                        <div class="flex-row-left-center">
                                                            <div class="MyMessage-date">보낸날짜: 2019.05.09 17:55</div>
                                            ...
                                            <!-- card card card card card card card card card card card card card card card  -->
                                             ...
                                             <div class="card">
                                                    <!-- card header -->
                                                    <div class="card-header flex-row-left-center" id="heading2">
                                                        <div class="MyMessage-accordion-checkbox flex-col-center-center">
                                                            <input type="checkbox"  name="checkOne">
                                                        </div>
                                                        <div class="flex-item-grow">
                                                            <button class="btn btn-link MyMessage-title" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="true" aria-controls="collapse2">
                                                                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                                            </button>
                                                        </div>
                                                        <div class="MyMessage-accordion-right">
                                                    ...
                                                    <!-- card body -->
                                                    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#NoticeAccordion">
                                                        <div class="card-body flex-col-left-up">
                                                            <div>
                                                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                                            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       	<div class="control-group flex-row-center-center">
            ...
            <div><input name="sujet" type="text" class="form-control"></div>
          </div>
          <br />
          <!-- TextArea Message -->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-orange">전송하기</button>
      </div>
    </div>
  </div>
</div>
