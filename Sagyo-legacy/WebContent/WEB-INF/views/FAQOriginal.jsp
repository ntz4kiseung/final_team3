...
<!-- 부트스트랩 -->
	...
	function loadXMLDocs()
	{
		...
		// 와 같이 헤더를 추가해 주어야 한다. 
		xmlHttp.open("POST","faq.action"+"?keyword="+ document.getElementById("keyword").value ,true);
                ...
                <div class="CustomerService flex-item-grow flex-col-center-up">
                    ...
                    <div class="CustomerService-body flex-item-grow flex-col-center-up">
                        ...
                        <div class="Withdrawal-body flex-col-center-start container"> <!--  게시판 영역 시작  -->
                        	...
                        	<form action="faq.action" method="post">
								    ...
								    <div class="card"> 
								      <div class="card-header"> 
								        <a class="card-link" data-toggle="collapse" data-parent="#accordion"  href="#collapse${faq.id }"> 
								          <span style="border:1px;">FAQ</span> ${faq.title }  <span>${faq.csDate }</span>
								        </a> 
								      </div> 
			                              ...
			                              <script type="text/javascript">
											...
											for (var i = 1; i <= max; i++)
											{
												...
												/* document.write("<button type='submit' id='pagesu' name='pagesu' value="+ print +">"+print+"</button>"); */
												 buttonPrint += "<button type='submit' id='pagesu' name='pagesu' value="+ print +">"+print+"</button>";
											}
											
											document.write(buttonPrint);
